...
@section('content')
        ...
        <span class="glyphicon glyphicon-arrow-left btn btn-danger home"><b><a href="{{route('Customers.index')}}">Back To show Customers</a> </b></span>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Edit Fields Customer:{{$customer->name}}</div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('Customers.update',$customer->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="city" type="text" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" value="{{$customer->city}}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="number" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{$customer->phone}}" required autofocus>
